...
// Parse extracts Java symbols, imports, and calls. The extraction shell lives
// in common.RunQuery; this wires in Java's symbol/import/call logic and the
// public-top-level export rule.
