...
// finalizeExports walks the top level once to collect `export` markers (the
// .scm query doesn't capture them directly), marks the matching symbols
// exported, and records the full export set. Anything under an
