...
each in pipeline_jobs, then writes the repo's CLAUDE.md.

Indexes into the global database (~/.config/vor/vor.db, or VOR_DB_URL).
Use 'vor register' instead to also have the daemon watch the repo for
